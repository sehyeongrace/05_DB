...
SELECT 'AABBCCABC', INSTR('AABBCCABC', 'B', 5, 3)
FROM DUAL; -- 9
...
-- EMPLOYEE 테이블에서
-- 직급코드가 'J7'인 사원의 급여를 기존 급여를 20% 인상
-- 직급코드가 'J6'인 사원의 급여를 기존 급여를 15% 인상
-- 직급코드가 'J5'인 사원의 급여를 기존 급여를 10% 인상
-- 나머지 사원은 5% 인상
