...
JOIN 
	DEPARTMENT ON (DEPT_CODE = DEPT_ID)
	-- EMPLOYEE 컬럼 14개 
	-- + DEPTARTMENT 컬럼 3개(DEPT_ID, DEPT_TITLE, LOCATION_ID)
...
WHERE 
	E.EMP_NO LIKE '8_____-2______' AND E.EMP_NAME LIKE '전%';
-- E.EMP_NO LIKE '8' AND SUBSTR(E.EMP_NO, 8, 1) = '2' AND E.EMP_NAME LIKE '전%';
...
--연봉에 보너스포인트를 적용하시오.
SELECT
	E.EMP_NAME, J.JOB_NAME, E.SALARY, E.SALARY * (1 + NVL(BONUS,0)) * 12 "연봉"
FROM
	EMPLOYEE E
JOIN
