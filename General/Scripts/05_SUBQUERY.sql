...
-- HAVING: GROUP BY절에 의해 만들어지 그룹중 조회를 원하는 그룹에 대한 조건
...
SELECT 
	E.EMP_ID, E.EMP_NAME, 
	NVL(DEPT_TITLE, '없음') AS DEPT_TITLE, J.JOB_NAME,
	CASE 
...
SELECT 
	E.EMP_ID, E.EMP_NAME,
	NVL(D.DEPT_TITLE, '소속 없음') DEPT_TITLE,
	JOB_NAME,
	HIRE_DATE
FROM 
	EMPLOYEE E
