...
CREATE USER TEST20_USER 
IDENTIFIED BY "TEST1234";

-- ORA-01045: 사용자 TEST20_USER는 
...
GRANT CREATE SESSION TO TEST20_USER;
--> 연결 확인됨


/* 생성된 사용자 계정으로 접속(TEST20_USER) */
...
/* TEST20_USER에게 테이블 생성 공간 할당 
 * - USERS폴더 내에 10M 할당
 * */
ALTER USER TEST20_USER
DEFAULT TABLESPACE USERS 
QUOTA 10M ON USERS;


/* 다시 TEST20_USER 계정 접속 후 테이블 생성 */
CREATE TABLE TEST_TABLE(
	TEST_NO NUMBER PRIMARY KEY, 
	TEST_COL VARCHAR2(30) NOT NULL
);
