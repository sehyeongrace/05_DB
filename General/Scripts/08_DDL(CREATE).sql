...
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER"
VALUES('MEM02', 'QWER1234', '김미영', '981122-1234567', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER"
VALUES('MEM03', '1QW23E4R', '박철수', '970101-1234567', DEFAULT);
...
VALUES
('MEM04', 'QQQQ2222', '신짱구', '990304-1234567');
...
/*
    ...
    제약조건 종류
    !!!다외워야함!!!PRIMARY KEY, NOT NULL, UNIQUE, CHECK, FOREIGN KEY.
...
CREATE TABLE USER_USED_FK(
  ...
  -- USER_GRADE의 테이블의 GRADE_CODE 컬럼에 저장된 작성된 값만 가능!
  -- == 참조
...
WHERE GRADE_CODE = 10;
--무결성 제약조건(KH20_CSH.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
...
SELECT * FROM USER_USED_FK3; --10 을 참조하던 홍길도, 이순신 삭제됨
...
-- 체크 제약조건(KH20_CSH.CHECK_SCORE)이 위배되었습니다
